        ...
        readonly allOf: readonly [{
            ...
            readonly properties: {
                ...
                readonly start: {
                    ...
                    readonly $schema: "http://json-schema.org/draft-04/schema#";
                    readonly description: "The inclusive start of the interval. Format: YYYY-MM-DD.\nIf missing, the default value is the current day.\n";
                };
                readonly end: {
                    readonly type: "string";
                    readonly format: "date";
                    ...
                    readonly $schema: "http://json-schema.org/draft-04/schema#";
                    readonly description: "The inclusive end of the interval. Format: YYYY-MM-DD.\nIf missing, the default value is the current day.\n";
                };
                readonly limit: {
        ...
        readonly allOf: readonly [{
            ...
            readonly properties: {
                ...
                readonly updated_since: {
                    ...
                    readonly format: "date-time";
                    readonly $schema: "http://json-schema.org/draft-04/schema#";
                    readonly description: "Filter to snapshots that were updated since this timestamp, meaning that the timestamp of the\ntrade or the quote is greater than or equal to this value.\nFormat: RFC-3339 or YYYY-MM-DD. If missing, all values are returned.\n";
                };
                readonly page_token: {
                    readonly type: "string";
                    readonly $schema: "http://json-schema.org/draft-04/schema#";
        ...
        readonly allOf: readonly [{
            ...
            readonly properties: {
                ...
                readonly asof: {
                    readonly type: "string";
                    readonly $schema: "http://json-schema.org/draft-04/schema#";
                    readonly description: "The asof date of the queried stock symbol(s) in YYYY-MM-DD format. Default is the current day.\n\nThis date is used to identify the underlying entity of the provided symbol(s) so that name\nchanges for this entity can be found. Data for past symbol(s) is returned if the query date\nrange spans the name change.\n\nThe special value of \"-\" means symbol mapping is skipped.\nData is returned based on the symbol alone without looking up previous names.\nThe same happens if the queried symbol is not found on the given asof date.\n\nExample: FB was renamed to META in 2022-06-09. Querying META with an asof date after\n2022-06-09 will also yield FB data. The data for the FB ticker will be labeled as META\nbecause they are considered the same underlying entity as of 2022-06-09.\nQuerying FB with an asof date after 2022-06-09 will only return data with the FB ticker,\nnot with META. But with an asof date before 2022-06-09, META will also be returned (as FB).\n";
                };
                readonly feed: {
                    readonly type: "string";
                ...
                readonly currency: {
                    readonly type: "string";
                    readonly $schema: "http://json-schema.org/draft-04/schema#";
                    readonly description: "The currency of all prices in ISO 4217 format. Default is USD.\n";
                };
                readonly page_token: {
                    readonly type: "string";
                    readonly $schema: "http://json-schema.org/draft-04/schema#";
